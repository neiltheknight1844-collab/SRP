...
public class SrpHumanoidRenderer extends HumanoidMobRenderer<SrpBasicMob, HumanoidModel<SrpBasicMob>> {

    public SrpHumanoidRenderer(EntityRendererProvider.Context ctx) {
